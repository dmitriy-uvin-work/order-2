...
class Application
{
    ...
    private function CheckTransaction()
    {
        ...
        $this->response->send([
            ...
            'perform_time' => $found->perform_time ? Format::datetime2timestamp($found->perform_time) : 0,
            'cancel_time'  => $found->cancel_time ? Format::datetime2timestamp($found->cancel_time) : 0,
